...
This guide covers how to set up the development environment and build VoiceLite from source across different platforms.
...
```bash
git clone git@github.com:MishkaMN/VoiceLite.git
cd VoiceLite
```
