{
  description = "VoiceLite - A free, open source, and extensible speech-to-text application that works completely offline";
  ...
  outputs =
    ...
    in
    {
      packages = forAllSystems (
        ...
        in
        {
          voicelite = pkgs.rustPlatform.buildRustPackage {
            pname = "voicelite";
            inherit version;
            src = self;
            ...
            meta = {
              ...
              homepage = "https://github.com/cjpais/VoiceLite";
              license = lib.licenses.mit;
              mainProgram = "voicelite";
              platforms = supportedSystems;
            };
          };

          default = self.packages.${system}.voicelite;
        }
      );
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "VoiceLite development environment"
              bun install
