          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-5">
            ...
            <div>
              ...
              <ul className="space-y-3 text-sm">
                ...
                <li>
                  <a href="#pricing" className="transition-colors hover:text-blue-400">
                    Pricing
                  </a>
                </li>
                <li>
          ...
          <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-stone-800 pt-8 text-sm md:flex-row">
            ...
            <div className="flex gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-stone-800 transition-colors hover:bg-blue-600 hover:text-white"
              >
                GH
              </a>
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-stone-800 transition-colors hover:bg-blue-600 hover:text-white">
                𝕏
              </a>
              <a href="#" className="flex h-10 w-10 items-center justify-center rounded-full bg-stone-800 transition-colors hover:bg-blue-600 hover:text-white">
                DC
