-- ============================================================================
-- VoiceLite Complete Database Schema Migration
-- ============================================================================
-- Run this in Supabase SQL Editor: https://supabase.com/dashboard/project/dzgqyytpkvjguxlhcpgl/sql/new
-- This will recreate all 14 tables with proper indexes and foreign keys
-- ============================================================================
...
-- ============================================================================
-- Tables created: 14
-- - User, MagicLinkToken, Session
-- - License, LicenseActivation, LicenseEvent
-- - Product, Purchase
-- - ApiKey, Feedback, UserActivity
-- - AnalyticsEvent, TelemetryMetric
-- - WebhookEvent
-- ============================================================================
